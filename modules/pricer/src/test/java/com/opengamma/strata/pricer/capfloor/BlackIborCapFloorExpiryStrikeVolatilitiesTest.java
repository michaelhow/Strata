...
/**
 * Test {@link BlackIborCapFloorExpiryStrikeVolatilities}.
 */
@Test
public class BlackIborCapFloorExpiryStrikeVolatilitiesTest {
  ...
  private static final DoubleArray STRIKE =
      DoubleArray.of(0.005, 0.01, 0.02, 0.035, 0.005, 0.01, 0.02, 0.035, 0.005, 0.01, 0.02, 0.035);
  ...
  static {
    ...
    METADATA = Surfaces.iborCapFloorBlackExpiryStrike("CAP_VOL", ACT_365F).withParameterMetadata(list);
  }
  ...
  private static final BlackIborCapFloorExpiryStrikeVolatilities VOLS =
      BlackIborCapFloorExpiryStrikeVolatilities.of(GBP_LIBOR_3M, VAL_DATE_TIME, SURFACE);
  ...
  public void test_volatility_sensitivity() {
    ...
    for (int i = 0; i < NB_TEST; i++) {
      for (int k = 0; k < NB_TEST; k++) {
        IborCapFloorSensitivity point = IborCapFloorSensitivity.of(
        ...
        for (int j = 0; j < nData; j++) {
          ...
          BlackIborCapFloorExpiryStrikeVolatilities provUp =
              BlackIborCapFloorExpiryStrikeVolatilities.of(GBP_LIBOR_3M, VAL_DATE_TIME, paramUp);
          BlackIborCapFloorExpiryStrikeVolatilities provDw =
              BlackIborCapFloorExpiryStrikeVolatilities.of(GBP_LIBOR_3M, VAL_DATE_TIME, paramDw);
