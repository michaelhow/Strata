...
/**
 * Test {@link NormalIborCapFloorExpiryStrikeVolatilities}.
 */
@Test
public class NormalIborCapFloorExpiryStrikeVolatilitiesTest {
  ...
  static {
    ...
    METADATA = Surfaces.iborCapFloorNormalExpiryStrike("CAP_VOL", ACT_365F).withParameterMetadata(list);
  }
  ...
  private static final NormalIborCapFloorExpiryStrikeVolatilities VOLS =
      NormalIborCapFloorExpiryStrikeVolatilities.of(GBP_LIBOR_3M, VAL_DATE_TIME, SURFACE);
    ...
    for (int i = 0; i < NB_TEST; i++) {
      for (int k = 0; k < NB_TEST; k++) {
        ...
        for (int j = 0; j < nData; ++j) {
          ...
          NormalIborCapFloorExpiryStrikeVolatilities provUp =
              NormalIborCapFloorExpiryStrikeVolatilities.of(GBP_LIBOR_3M, VAL_DATE_TIME, paramUp);
          NormalIborCapFloorExpiryStrikeVolatilities provDw =
              NormalIborCapFloorExpiryStrikeVolatilities.of(GBP_LIBOR_3M, VAL_DATE_TIME, paramDw);
