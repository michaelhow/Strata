...
public interface IborCapFloorVolatilities
   ...
   * @return the name
   */
  public abstract IborCapFloorVolatilitiesName getName();
  ...
  /**
   * Gets the type of volatility returned by the {@link IborCapFloorVolatilities#volatility} method.
   * 
   * @return the type
   */
  ...
  @Override
  public abstract IborCapFloorVolatilities withParameter(int parameterIndex, double newValue);

  @Override
  public abstract IborCapFloorVolatilities withPerturbation(ParameterPerturbation perturbation);
