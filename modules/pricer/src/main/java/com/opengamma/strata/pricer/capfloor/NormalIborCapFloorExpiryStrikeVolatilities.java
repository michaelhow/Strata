...
/**
 * Volatility for Ibor cap/floor in the normal or Bachelier model based on a surface.
 * <p>
 * The volatility is represented by a surface on the expiry and strike dimensions.
 */
@BeanDefinition(builderScope = "private")
public final class NormalIborCapFloorExpiryStrikeVolatilities
    implements NormalIborCapFloorVolatilities, ImmutableBean, Serializable {
   ...
   * {@link Surfaces#iborCapFloorNormalExpiryStrike(String, DayCount)}.
   * 
   ...
   */
  public static NormalIborCapFloorExpiryStrikeVolatilities of(
      IborIndex index,
      ZonedDateTime valuationDateTime,
      Surface surface) {

    return new NormalIborCapFloorExpiryStrikeVolatilities(index, valuationDateTime, surface);
  }

  @ImmutableConstructor
  private NormalIborCapFloorExpiryStrikeVolatilities(
      IborIndex index,
      ZonedDateTime valuationDateTime,
      Surface surface) {
  ...
  public IborCapFloorVolatilitiesName getName() {
    return IborCapFloorVolatilitiesName.of(surface.getName().getName());
  }
  ...
  @Override
  public NormalIborCapFloorExpiryStrikeVolatilities withParameter(int parameterIndex, double newValue) {
    return new NormalIborCapFloorExpiryStrikeVolatilities(
        index, valuationDateTime, surface.withParameter(parameterIndex, newValue));
  }

  @Override
  public NormalIborCapFloorExpiryStrikeVolatilities withPerturbation(ParameterPerturbation perturbation) {
    return new NormalIborCapFloorExpiryStrikeVolatilities(
  ...
  public CurrencyParameterSensitivities parameterSensitivity(PointSensitivities pointSensitivities) {
    ...
    for (PointSensitivity point : pointSensitivities.getSensitivities()) {
      if (point instanceof IborCapFloorSensitivity) {
        IborCapFloorSensitivity pt = (IborCapFloorSensitivity) point;
  ...
  private CurrencyParameterSensitivity parameterSensitivity(IborCapFloorSensitivity point) {
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code NormalIborCapFloorExpiryStrikeVolatilities}.
   * @return the meta-bean, not null
   */
  public static NormalIborCapFloorExpiryStrikeVolatilities.Meta meta() {
    return NormalIborCapFloorExpiryStrikeVolatilities.Meta.INSTANCE;
  }

  static {
    JodaBeanUtils.registerMetaBean(NormalIborCapFloorExpiryStrikeVolatilities.Meta.INSTANCE);
  }
  ...
  @Override
  public NormalIborCapFloorExpiryStrikeVolatilities.Meta metaBean() {
    return NormalIborCapFloorExpiryStrikeVolatilities.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      NormalIborCapFloorExpiryStrikeVolatilities other = (NormalIborCapFloorExpiryStrikeVolatilities) obj;
  ...
  public String toString() {
    ...
    buf.append("NormalIborCapFloorExpiryStrikeVolatilities{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<IborIndex> index = DirectMetaProperty.ofImmutable(
        this, "index", NormalIborCapFloorExpiryStrikeVolatilities.class, IborIndex.class);
    /**
     * The meta-property for the {@code valuationDateTime} property.
     */
    private final MetaProperty<ZonedDateTime> valuationDateTime = DirectMetaProperty.ofImmutable(
        this, "valuationDateTime", NormalIborCapFloorExpiryStrikeVolatilities.class, ZonedDateTime.class);
    /**
     * The meta-property for the {@code surface} property.
     */
    private final MetaProperty<Surface> surface = DirectMetaProperty.ofImmutable(
        this, "surface", NormalIborCapFloorExpiryStrikeVolatilities.class, Surface.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends NormalIborCapFloorExpiryStrikeVolatilities> builder() {
      return new NormalIborCapFloorExpiryStrikeVolatilities.Builder();
    }

    @Override
    public Class<? extends NormalIborCapFloorExpiryStrikeVolatilities> beanType() {
      return NormalIborCapFloorExpiryStrikeVolatilities.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 100346066:  // index
          return ((NormalIborCapFloorExpiryStrikeVolatilities) bean).getIndex();
        case -949589828:  // valuationDateTime
          return ((NormalIborCapFloorExpiryStrikeVolatilities) bean).getValuationDateTime();
        case -1853231955:  // surface
          return ((NormalIborCapFloorExpiryStrikeVolatilities) bean).getSurface();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code NormalIborCapFloorExpiryStrikeVolatilities}.
   */
  private static final class Builder extends DirectFieldsBeanBuilder<NormalIborCapFloorExpiryStrikeVolatilities> {
    ...
    @Override
    public NormalIborCapFloorExpiryStrikeVolatilities build() {
      return new NormalIborCapFloorExpiryStrikeVolatilities(
          index,
          valuationDateTime,
          surface);
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(128);
      buf.append("NormalIborCapFloorExpiryStrikeVolatilities.Builder{");
